...
from ipacta.config import (
    IpactaConfig,
    IPACTA_DEFAULTS,
    WSGI_DEFAULTS,
)
from ipacta.exceptions import InvalidCAConfiguration


# ======================================================================
# IPACTA_DEFAULTS and WSGI_DEFAULTS
# ======================================================================
...
class TestDefaults:
    ...
    def test_ipacta_defaults_keys(self):
        """IPACTA_DEFAULTS has all expected keys."""
        expected_keys = {
...
# ======================================================================
# IpactaConfig construction
# ======================================================================


class TestConfigConstruction:
    """Test IpactaConfig construction methods."""
    ...
    def test_from_install_params_basic(self):
        ...
        cfg = IpactaConfig.from_install_params(
            realm="TEST.REALM",
    ...
    def test_from_install_params_none_keeps_defaults(self):
        """None params keep IPACTA_DEFAULTS values."""
        cfg = IpactaConfig.from_install_params(
            realm="TEST.REALM",
            host="host.test.realm",
            basedn="dc=test,dc=realm",
        ...
        assert (
            ...
            == IPACTA_DEFAULTS["ca_signing_algorithm"]
        )
        assert cfg._ecc_curve == IPACTA_DEFAULTS["ecc_curve"]
...
class TestConfigFileIO:
    ...
    def test_from_file_missing_strict(self):
        ...
        with pytest.raises(FileNotFoundError):
            IpactaConfig.from_file(
                "/nonexistent/ipacta.conf", strict=True
            )
    ...
    def test_from_file_missing_nonstrict(self):
        ...
        cfg = IpactaConfig.from_file(
            "/nonexistent/ipacta.conf", strict=False
        )
        assert cfg.realm is None
    ...
    def test_from_file_reads_existing(self):
        ...
        try:
            cfg = IpactaConfig.from_file(tmpfile)
...
class TestGetConfigValue:
    ...
    def test_get_existing_value(self, ipacta_config):
    ...
    def test_get_missing_with_default(self, ipacta_config):
    ...
    def test_get_missing_no_default_raises(self, ipacta_config):
