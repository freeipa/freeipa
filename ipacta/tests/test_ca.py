...
against a running ipacta service.
"""

import os
import pytest

from ipacta.tests.conftest import (
    requires_deployment,
    curl_get_json,
    curl_post_json,
    generate_csr,
...
class TestCertificateLifecycleE2E:
    ...
    def test_revoke_certificate(self, base_url, ra_creds):
        ...
        status, _revoke_data = curl_post_json(
            base_url,
            f"/ca/rest/certs/{cert_id}/revoke",
            revoke_payload,
            client_cert=ra_cert,
            client_key=ra_key,
        )
