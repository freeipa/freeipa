...
class TestCertificateState:
    ...
    def test_all_states_defined(self):
        ...
        expected = {"PENDING", "VALID", "EXPIRED", "REVOKED",
                    "ON_HOLD", "SUPERSEDED"}
...
class TestCertificateEvent:
    ...
    def test_all_events_defined(self):
        ...
        expected = {"ISSUE", "EXPIRE", "REVOKE", "HOLD",
                    "RELEASE", "SUPERSEDE"}
...
class TestCertificateLifecycle:
    ...
    def test_get_allowed_events_valid(self):
        ...
        lc = CertificateLifecycle(initial_state=CertificateState.VALID)
        expected = {CertificateEvent.EXPIRE, CertificateEvent.REVOKE,
                    CertificateEvent.HOLD, CertificateEvent.SUPERSEDE}
    ...
    def test_get_next_state(self):
        ...
        lc = CertificateLifecycle()
        assert lc.get_next_state(CertificateEvent.ISSUE) == \
