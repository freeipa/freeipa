...
"""Resource usage tracking for ipathinca.
...
Periodic logging (e.g. every 5 minutes at DEBUG level)::
    ...
    from ipathinca.resource_tracker import start_periodic_logging
...
Enable tracemalloc for allocation tracing::
    ...
    from ipathinca.resource_tracker import enable_tracemalloc
...
def _get_ldap_pool_stats() -> Optional[LDAPPoolStats]:
    try:
        from ipathinca.ldap_utils import _connection_pool
