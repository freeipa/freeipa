...
asn_TYPE_member_t asn_MBR_GKNewKeys_1[] = {
...
static const int asn_MAP_GKNewKeys_oms_1[] = { 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_GKNewKeys_specs_1 = {
	sizeof(struct GKNewKeys),
	offsetof(struct GKNewKeys, _asn_ctx),
	asn_MAP_GKNewKeys_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_GKNewKeys_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
