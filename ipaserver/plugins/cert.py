...
# When running make lint with Python 2, the dns submodule imports don't work
# without this.
...
def _ip_rdns_ok(ip, fqdn):
    """
    Check and IP address's reverse DNS record.
    ...
    # This assumes that the IP only has 1 A/AAAA record pointing to it (which
