...
from ipalib.messages import ServerPasssyncMgrUpdateRequired
...
class sysaccount(LDAPObject):
    ...
    def handle_reset(self, cmd, next_cmd, ldap, dn, **options):
        if 'update_without_reset' in options:
            ...
            add_to_passsync_mgrs = options.get('update_without_reset', False)
            try:
                ...
                pass
            del options['update_without_reset']
...
class sysaccount_add(LDAPCreate):
    ...
    def post_callback(self, ldap, dn, entry_attrs, *keys, **options):
        ...
        self.obj.handle_reset(self, self.api.Command.sysaccount_allow_reset,
                              ldap, dn, **options)
        return dn
...
class sysaccount_del(LDAPDelete):
    ...
    def pre_callback(self, ldap, dn, *keys, **options):
        ...
        try:
            options['update_without_reset'] = False
...
@register()
class sysaccount_allow_reset(LDAPRetrieve):
    __doc__ = _(
