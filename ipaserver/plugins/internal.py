...
class i18n_messages(Command):
    ...
    messages = {
        ...
        "objects": {
            ...
            "sysaccount": {
                "add": _("Add system account"),
                "remove": _("Remove system account"),
                "add_into_roles": _(
                    "Add system account '${primary_key}' into roles"
                ),
                "remove_from_roles": _(
                    "Remove system account '${primary_key}' from roles"
                ),
                "privileged": _(
                    "Change passwords without reset"
                ),
                "privileged_confirm": _(
                    "Change privileged status of '${primary_key}' "
                    "system account"
                )
        ...
        "ssbrowser-page": {
            ...
            "chrome-spnego": _(
                ...
                "<div><code>\n"
                "                    [root@server]# echo \'{ \""
                "AuthServerAllowlist\": \"*<span class=\"example-domain\">"
