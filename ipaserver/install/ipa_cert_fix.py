...
class IPACertFix(AdminTool):
    ...
    def run(self):
        ...
        if any(key == 'ca_issuing' for key, _ in certs):
            ...
            print(
                "The CA signing certificate is expired or close to being "
                "expired.\n\nipa-cert-fix cannot proceed, please refer to the "
                "ipa-cacert-manage tool to renew the CA certificate before "
                "proceeding."
            )
            return 1
