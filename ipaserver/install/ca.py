...
def install_step_0(standalone, replica_config, options, custodia):
    ...
    if use_ipathinca:
        ...
        ca = IPAThinCAInstance(
            ...
            token_library_path=options.token_library_path if hasattr(options, 'token_library_path') else None,
            token_password=options.token_password if hasattr(options, 'token_password') else None,
