...
def install(standalone, replica, options, api=api):
    ...
    if standalone:
        if options.dns_over_tls and options.dns_policy == "relaxed":
            dns_port = "53, 853"
        elif options.dns_over_tls and options.dns_policy == "enforced":
            dns_port = "853"
        else:
            dns_port = "53"
        print("==============================================================================")
...
class DNSInstallInterface(hostname.HostNameInstallInterface):
    ...
    * ipa-dns-install
    ...
    dns_policy = knob(
        EncryptedDNSPolicy, EncryptedDNSPolicy.RELAXED,
