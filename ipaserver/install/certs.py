...
default_ca_key_strength = dict(
    # FIXME: The default should be ML-DSA-87 but this requires a
    # larger AJP proxy buffer setting in both Apache and Tomcat.
    # This is fixed upstream in dogtag but needs a new build.
    rsa="3072",
    mldsa="65"
)
