...
ipa namespace-add-service xyz --service hbacrule
...
ipa namespace-remove-service xyz --service hbacrule
...
A namespace contains a single automount location named after the namespace. We give free reign to this namespace.
...
I beleive in the long-run it is more straightforward for cn=admins to manage the available groups that can be added to namespace sudo rules.
...
| ipa namespace-find | |
| ipa namespace-add-service | xyz --service idviews |
| ipa namespace-remove-service | xyz --service idviews |
...
This is going to require a rather massive new test suite. All delegations will need to be positive tested for what should minimally work:
