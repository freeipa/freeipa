...
class BasePathNamespace:
    ...
    # Legacy paths for upgrade detection / migration
    DNSSEC_SOFTHSM2_CONF = "/etc/ipa/dnssec/softhsm2.conf"
    DNSSEC_SOFTHSM_PIN_SO = DNSSEC_HSM_PIN_SO
    LEGACY_DNSSEC_SOFTHSM_PIN_SO = "/etc/ipa/dnssec/softhsm_pin_so"
    ...
    # Deprecated alias for upgrade detection
    DNSSEC_SOFTHSM_PIN = DNSSEC_HSM_PIN
    LEGACY_DNSSEC_SOFTHSM_PIN = "/var/lib/ipa/dnssec/softhsm_pin"
