...
class group_find(Method):
    ...
    takes_options = (
        ...
        parameters.Flag(
            'external',
            doc=_(
                'search for groups with support of external non-IPA members '
        ...
        parameters.Str(
            ...
            cli_name='users',
            label=_('user'),
            doc=_('Search for groups with these member users.'),
        ),
        parameters.Str(
            'no_user',
            required=False,
            ...
            cli_name='no_users',
            label=_('user'),
            doc=_('Search for groups without these member users.'),
        ),
        parameters.Str(
            'group',
            required=False,
            ...
            cli_name='groups',
            label=_('group'),
            doc=_('Search for groups with these member groups.'),
        ),
        parameters.Str(
            'no_group',
            required=False,
            ...
            cli_name='no_groups',
            label=_('group'),
            doc=_('Search for groups without these member groups.'),
        ),
        parameters.Str(
            'in_group',
            required=False,
            ...
            cli_name='in_groups',
            label=_('group'),
            doc=_('Search for groups with these member of groups.'),
        ),
        parameters.Str(
            'not_in_group',
            required=False,
            ...
            label=_('group'),
            doc=_('Search for groups without these member of groups.'),
        ),
        parameters.Str(
            'in_netgroup',
            required=False,
            ...
            label=_('netgroup'),
            doc=_('Search for groups with these member of netgroups.'),
        ),
        parameters.Str(
            'not_in_netgroup',
            required=False,
            ...
            label=_('netgroup'),
            doc=_('Search for groups without these member of netgroups.'),
        ),
        parameters.Str(
            'in_role',
            required=False,
            ...
            cli_name='in_roles',
            label=_('role'),
            doc=_('Search for groups with these member of roles.'),
        ),
        parameters.Str(
            'not_in_role',
            required=False,
            ...
            label=_('role'),
            doc=_('Search for groups without these member of roles.'),
        ),
        parameters.Str(
            'in_hbacrule',
            required=False,
            ...
            label=_('HBAC rule'),
            doc=_('Search for groups with these member of HBAC rules.'),
        ),
        parameters.Str(
            'not_in_hbacrule',
            required=False,
            ...
            label=_('HBAC rule'),
            doc=_('Search for groups without these member of HBAC rules.'),
        ),
        parameters.Str(
            'in_sudorule',
            required=False,
            ...
            label=_('sudo rule'),
            doc=_('Search for groups with these member of sudo rules.'),
        ),
        parameters.Str(
            'not_in_sudorule',
            required=False,
            ...
            label=_('sudo rule'),
            doc=_('Search for groups without these member of sudo rules.'),
        ),
    )
    has_output = (
        output.Output(
...
class group_mod(Method):
    ...
    takes_options = (
        ...
        parameters.Flag(
            'external',
            doc=_(
                'change to support external non-IPA members from trusted '
                'domains'
            ),
            default=False,
            autofill=True,
