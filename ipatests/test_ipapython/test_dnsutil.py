...
class TestSortSRV:
    ...
    def test_one(self):
        h1 = mksrv(1, 0, 443, "host1")
        assert dnsutil.sort_prio_weight([h1]) == [h1]

        h2 = mksrv(10, 5, 443, "host2")
        assert dnsutil.sort_prio_weight([h2]) == [h2]

    def test_prio(self):
        h1 = mksrv(1, 0, 443, "host1")
        h2 = mksrv(2, 0, 443, "host2")
        h3 = mksrv(3, 0, 443, "host3")
    ...
    def test_weight(self):
        h1 = mksrv(1, 0, 443, "host1")
        h2_w15 = mksrv(2, 15, 443, "host2")
        h3_w10 = mksrv(2, 10, 443, "host3")
...
class TestSortURI:
    def test_prio(self):
        h1 = mkuri(1, 0, "https://host1/api")
        h2 = mkuri(2, 0, "https://host2/api")
        h3 = mkuri(3, 0, "https://host3/api")
        assert dnsutil.sort_prio_weight([h3, h2, h1]) == [h1, h2, h3]
        assert dnsutil.sort_prio_weight([h3, h3, h3]) == [h3]
        assert dnsutil.sort_prio_weight([h2, h2, h1, h1]) == [h1, h2]
