    ...
    def test_selinuxusermap_008_empty_default(self):
        ...
        for case in self._selinux_domain_cases():
            ...
            try:
                ...
                # 008: password SSH from client1 — unconfined_u to master
                # and client2 for both users.
                for user in (user1, user2):
                    self._verify_password_ssh_selinux_from(
                        self.clients[0], user,
                        (
                ...
                # 008: password SSH from client2 — unconfined_u to master
                # and client1 for both users.
                for user in (user1, user2):
                    self._verify_password_ssh_selinux_from(
                        self.clients[1], user,
                        (
