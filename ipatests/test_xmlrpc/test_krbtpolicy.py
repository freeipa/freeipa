...
invalid_values = [('abc123', 'must be an integer'),
                  ('2147483648', 'can be at most 2147483647'),
    ...
    tests = [
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    krbmaxticketlife=['3600'],
                    krbauthindmaxticketlife_pkinit=['3800'],
                ),
            ),
        ),
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    krbmaxticketlife=['3600'],
                    krbauthindmaxticketlife_pkinit=['3800'],
                    krbauthindmaxticketlife_otp=['3700'],
                ),
            ),
        ),
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxticketlife_otp=['3700'],
                    krbauthindmaxticketlife_pkinit=['3800'],
                    krbauthindmaxticketlife_radius=['1'],
                ),
            ),
        ),
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxticketlife_pkinit=['3800'],
                    krbauthindmaxticketlife_radius=['1'],
                    krbauthindmaxticketlife_hardened=['2147483647'],
                ),
            ),
        ),
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxticketlife_radius=['1'],
                    krbauthindmaxticketlife_hardened=['2147483647'],
                    krbauthindmaxrenewableage_hardened=['2147483647'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxticketlife_hardened=['2147483647'],
                    krbauthindmaxrenewableage_hardened=['2147483647'],
                    krbauthindmaxrenewableage_otp=['3700'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxrenewableage_hardened=['2147483647'],
                    krbauthindmaxrenewableage_otp=['3700'],
                    krbauthindmaxrenewableage_radius=['1'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxrenewableage_otp=['3700'],
                    krbauthindmaxrenewableage_radius=['1'],
                    krbauthindmaxrenewableage_pkinit=['3800'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxrenewableage_radius=['1'],
                    krbauthindmaxrenewableage_pkinit=['3800'],
                    krbauthindmaxrenewableage_idp=['3900'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxrenewableage_pkinit=['3800'],
                    krbauthindmaxrenewableage_idp=['3900'],
                    krbauthindmaxticketlife_idp=['3900'],
                ),
            ),
        ),
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxrenewableage_idp=['3900'],
                    krbauthindmaxticketlife_idp=['3900'],
                    krbauthindmaxrenewableage_passkey=['4000'],
                ),
            ),
        ),
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    ...
                    krbauthindmaxticketlife_idp=['3900'],
                    krbauthindmaxrenewableage_passkey=['4000'],
                    krbauthindmaxticketlife_passkey=['4100'],
                ),
            ),
        ),
        ...
        dict(
            ...
            command=(
                'krbtpolicy_mod', [user1], dict(setattr='givenname=Pete')
            ),
