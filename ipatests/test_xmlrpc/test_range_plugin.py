    ...
    tests = [
        dict(
            ...
            expected=dict(
                result=dict(
                    ...
                    ipasecondarybaserid=[str(testrange1_secondary_base_rid)],
                    ipaidrangesize=[str(testrange1_size)],
        ...
        dict(
            ...
            expected=dict(
                result=dict(
                    ...
                    ipabaserid=[str(testrange2_base_rid)],
                    ipasecondarybaserid=[str(testrange2_secondary_base_rid)],
                    ipaidrangesize=[str(testrange2_size)],
                    iparangetyperaw=['ipa-local'],
                    iparangetype=['local domain range'],
                ),
                value=testrange2,
        ...
        dict(
            ...
            expected=dict(
                result=dict(
                    ...
                    ipabaseid=[str(domain7range1_base_id)],
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    cn=[domain3range2],
                    ipabaseid=[str(domain3range1_base_id)],
        ...
        dict(
            ...
            expected=dict(
                ...
                result=dict(
                    cn=[domain2range1],
                    ipabaseid=[str(domain2range1_base_id)],
                    ipabaserid=[str(domain5range1_base_rid)],
                    ipaidrangesize=[str(domain2range1_size)],
                    ipanttrusteddomainsid=[str(domain2_sid)],
