...
class TestSysaccountPermissions(XMLRPC_test):
    ...
    def test_normal_user_cannot_modify_sysaccount(self):
    ...
    def test_normal_user_cannot_delete_sysaccount(self):
    ...
    def test_security_architect_can_modify_sysaccount(self):
        """Test that a Security Architect user can modify a system account"""
        # First create the sysaccount
        api.Command.sysaccount_add(TEST_SYSACCOUNT_3, random=True)
        ...
        try:
            with change_principal(SECURITY_ARCHITECT_USER,
                ...
                assert show_result['result']['description'] == [
                    u'Modified by Security Architect'
                ]
        finally:
            # Clean up
            try:
    ...
    def test_security_architect_can_delete_sysaccount(self):
        ...
        try:
            with change_principal(SECURITY_ARCHITECT_USER,
                ...
                assert result['result']['description'] == [
                    u'Test system account for show'
                ]
        finally:
            # Clean up
            try:
        ...
        try:
            with change_principal(SECURITY_ARCHITECT_USER,
                ...
                for entry in result['result']:
                    if entry.get('uid') == [TEST_SYSACCOUNT_2]:
                        found = True
                        assert entry.get('description') == [
                            u'Test system account for find'
                        ]
                        break
    ...
    def test_security_architect_can_disable_sysaccount(self):
        """Test that a Security Architect user can disable a system account"""
        # First create the sysaccount as admin
        api.Command.sysaccount_add(TEST_SYSACCOUNT_2, random=True)
    ...
    def test_security_architect_can_enable_sysaccount(self):
    ...
    def test_security_architect_can_set_sysaccount_policy(self):
